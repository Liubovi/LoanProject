    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') _this.activeBtn = btn;
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      document.querySelectorAll('.netmodule').forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.sliides[i].tagName !== "BUTTON") {
